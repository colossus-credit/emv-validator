...
(async () => {
  ...
  // New 52-byte ATC(2) || PDOL(50) slice-from-front message.
  ...
  const signedData = Buffer.from(messageHex, 'hex');
  ...
  const privateKey = await webcrypto.subtle.importKey(
    ...
    Buffer.from(
      ...
      privateKeyHex + 'a14403420004' + pubkeyXHex + pubkeyYHex,
      'hex'
    ),
  ...
  console.log('\nSignature valid (raw WebCrypto, low-s normalized):', isValid);
